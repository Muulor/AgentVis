...
![初始设置引导](../../website/assets/quick_start.gif)
...
![Local Provider 配置](../../website/assets/local_provider.png)

### 2.2 配置云端服务

进入「设置 -> 云端服务」后，至少需要完成两类配置：

- Embedding 模型供应商密钥：用于知识库、记忆和语义检索。
- 记忆系统 LLM：用于记忆摘要生成与事实提取。

建议同时申请并配置 Tavily 密钥。配置后，Agent 可以更稳定地使用网络搜索工具查询公开资料。

![云端服务基础配置](../../website/assets/cloud_service_1.png)

图像生成服务不是初始使用的必填项。如果你希望 Agent 直接生成图片、海报或视觉素材，可以按需配置。

![图像生成服务配置](../../website/assets/cloud_service_2.png)
...
![模型管理设置](../../website/assets/model_management.png)
...
![保护路径与 Trash Bin](../../website/assets/protected%20_paths_trashbin.png)
...
![数据管理与备份](../../website/assets/data_management.png)
...
![浏览器自动化技能依赖](../../website/assets/agent_browser.png)
...
![Safety Footer 与决策轮次](../../website/assets/safety_footer_planningLoopBudget.png)
...
![Agent Rules 设置](../../website/assets/agent_rules.png)
...
![知识库设置](../../website/assets/knowledge.png)
...
![定时任务设置](../../website/assets/scheduled%20tasks.png)
...
![工作区文件与项目关联](../../website/assets/document.png)
...
右侧工作区支持从电脑任意路径拖入文件或文件夹。导入后，Agent 可以在工作区范围内读取这些文件。
