...
export const useStatusStore = create<StatusState>((set, get) => ({
    ...
    addTokenUsage: (agentId, inputTokens, outputTokens) => set((state) => {
    ...
    setContextPressure: (agentId, currentInput, windowSize) => set((state) => ({
        contextPressureByAgent: {
