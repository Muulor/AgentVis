...
function getTranslationValue(resource: TranslationResource, key: TranslationKey): string | undefined {
...
export function translate(
    ...
    const translated = getTranslationValue(resources[language], key) ?? getTranslationValue(zhCN, key) ?? key;
