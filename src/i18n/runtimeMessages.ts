...
const u = (value: string): string =>
  value.replace(/\\u([0-9a-fA-F]{4})/g, (_match: string, code: string) => {
...
const PHASE_KEY_BY_TEXT: Record<string, TranslationKey> = {
  ...
  [u('\\u51c6\\u5907\\u9884\\u7f6e Python \\u73af\\u5883')]:
    'runtime.progress.preparePrebuiltRuntime',
  [u('\\u521b\\u5efa\\u865a\\u62df\\u73af\\u5883')]: 'runtime.progress.createVenv',
  [u('\\u6821\\u9a8c\\u9884\\u7f6e\\u57fa\\u7840\\u4f9d\\u8d56')]:
    'runtime.progress.verifyBaseRuntime',
  [u('\\u57fa\\u7840\\u4f9d\\u8d56\\u5b8c\\u6210')]: 'runtime.progress.baseComplete',
  [u('\\u5b89\\u88c5\\u989d\\u5916\\u4f9d\\u8d56')]: 'runtime.progress.installExtraDeps',
  [u('\\u5b89\\u88c5\\u6280\\u80fd\\u989d\\u5916\\u4f9d\\u8d56')]:
    'runtime.progress.installSkillExtraDeps',
...
const LEGACY_PARTIAL_FAILED = u(
  '\\u90e8\\u5206\\u4f9d\\u8d56\\u5b89\\u88c5\\u5931\\u8d25\\uff08\\u7f51\\u7edc\\u95ee\\u9898\\uff09\\uff0c\\u8bf7\\u5728\\u300c\\u6280\\u80fd\\u8bbe\\u7f6e\\u300d\\u4e2d\\u70b9\\u51fb\\u300c\\u5237\\u65b0\\u5217\\u8868\\u300d\\u91cd\\u8bd5'
);
const LEGACY_NETWORK_FAILED = u(
  '\\u4f9d\\u8d56\\u5b89\\u88c5\\u5931\\u8d25\\uff08\\u53ef\\u80fd\\u662f\\u7f51\\u7edc\\u95ee\\u9898\\uff09\\uff0c\\u8bf7\\u5728\\u300c\\u6280\\u80fd\\u8bbe\\u7f6e\\u300d\\u4e2d\\u70b9\\u51fb\\u300c\\u5237\\u65b0\\u5217\\u8868\\u300d\\u91cd\\u8bd5'
);
const LEGACY_TIMEOUT = u(
  '\\u6280\\u80fd\\u4f9d\\u8d56\\u5b89\\u88c5\\u8d85\\u65f6\\uff0c\\u8bf7\\u5728\\u300c\\u6280\\u80fd\\u8bbe\\u7f6e\\u300d\\u4e2d\\u70b9\\u51fb\\u300c\\u5237\\u65b0\\u5217\\u8868\\u300d\\u91cd\\u8bd5'
);
...
export function translateDependencyInstallResultMessage(message: string, t: Translate): string {
  ...
  if (
    /^Some dependencies failed to install due to a network issue\. Click "Refresh List" in Skill settings to retry\.$/i.test(
      normalizedMessage
    ) ||
  ...
  if (
    /^Dependency installation failed, possibly due to a network issue\. Click "Refresh List" in Skill settings to retry\.$/i.test(
      normalizedMessage
    ) ||
  ...
  if (
    /^Skill dependency installation timed out\. Click "Refresh List" in Skill settings to retry\.$/i.test(
      normalizedMessage
    ) ||
