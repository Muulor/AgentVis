...
export class TaskArtifactStore {
  ...
  constructor(private readonly maxTotalTokens: number = DEFAULT_MAX_TOTAL_TOKENS) {}
  ...
  getTotalTokens(): number {
    return Array.from(this.artifacts.values()).reduce((sum, a) => sum + a.estimatedTokens, 0);
  }
