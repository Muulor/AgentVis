...
type JobStateListener = (messageId: string, state: VisualEnhancementJobState | null) => void;

function syncJobStateToChatStore(messageId: string, state: VisualEnhancementJobState | null): void {
