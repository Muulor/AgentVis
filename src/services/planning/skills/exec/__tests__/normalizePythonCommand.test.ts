...
const VENV_PATH =
  'C:\\Users\\Admin\\AppData\\Roaming\\com.agentvis.app\\runtime\\venv\\Scripts\\python.exe';
...
describe('normalizePythonCommand', () => {
  ...
  it('应正确替换技能包脚本的完整命令', () => {
    const cmd =
      'python "C:/Users/Admin/AppData/Roaming/com.agentvis.app/skills/external/packages/yahoo-finance/yf.py" fundamentals 7453.T';
    const result = normalizePythonCommand(cmd, VENV_PATH);
    expect(result).toBe(
      `"${VENV_PATH}" "C:/Users/Admin/AppData/Roaming/com.agentvis.app/skills/external/packages/yahoo-finance/yf.py" fundamentals 7453.T`
    );
  });
