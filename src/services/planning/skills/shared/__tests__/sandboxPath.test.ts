...
describe('sandboxPath', () => {
    it('allows paths inside workdir in OfflineIsolated mode', () => {
        expect(getSandboxPathViolation('C:/Users/Test/AgentWork/report.md', isolatedContext)).toBeNull();
        expect(getSandboxPathViolation('C:\\Users\\Test\\AgentWork\\nested\\file.txt', isolatedContext)).toBeNull();
    });
    ...
    it('allows linked project roots in OfflineIsolated mode', () => {
        const context: ToolExecutionContext = {
            ...
            sandboxRoots: [
                'E:/docs',
                'C:/Users/Test/AgentDeliverables',
            ],
        };

        expect(getSandboxPathViolation('E:/docs/analysis_results.md', context)).toBeNull();
        expect(getSandboxPathViolation('C:/Users/Test/AgentDeliverables/report.md', context)).toBeNull();
    });
    ...
    it('allows host filesystem paths when controlled-network mode uses local filesystem scope', () => {
        expect(getSandboxPathViolation('C:/Users/Test/.github_token.json', {
            sandboxMode: 'ControlledNetwork',
    ...
    it('does not restrict LocalAudit mode', () => {
        expect(getSandboxPathViolation('C:/Users/Test/Other/file.txt', {
