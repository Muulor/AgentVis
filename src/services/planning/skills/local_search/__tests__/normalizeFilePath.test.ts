...
describe('normalizeFilePath', () => {
    it('应修正 Git Bash 风格 /f/ 为 f:/', () => {
        expect(normalizeFilePath('/f/AgentVis/src/App.tsx'))
            .toBe('f:/AgentVis/src/App.tsx');
    });

    it('应修正 Git Bash 风格 /c/ 为 c:/', () => {
        expect(normalizeFilePath('/c/Users/Admin/Desktop'))
            .toBe('c:/Users/Admin/Desktop');
    });

    it('应修正大写盘符 /F/', () => {
        expect(normalizeFilePath('/F/project/src'))
            .toBe('F:/project/src');
    });
