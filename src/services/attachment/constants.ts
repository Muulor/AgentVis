...
export const DOCUMENT_ERROR_MESSAGES = {
  ...
  ENCODING_DETECTION_FAILED: () => translate('chat.encodingDetectionFailed'),

  EMPTY_DOCUMENT: () => translate('chat.emptyDocument'),
...
export const DOCUMENT_PROGRESS_MESSAGES = {
  get ANALYZING() {
    return translate('chat.documentProgressAnalyzing');
  },
  get ENCODING_DETECTION() {
    return translate('chat.documentProgressEncoding');
  },
  get EXTRACTING() {
    return translate('chat.documentProgressExtracting');
  },
  get TRUNCATING() {
    return translate('chat.documentProgressTruncating');
  },
  get INDEXING() {
    return translate('chat.documentProgressIndexing');
  },
  get COMPLETED() {
    return translate('chat.documentProgressCompleted');
  },
} as const;
