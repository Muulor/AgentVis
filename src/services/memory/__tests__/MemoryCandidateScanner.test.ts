...
describe('MemoryCandidateScanner', () => {
    ...
    describe('偏好类 (preference_style) 匹配', () => {
        ...
        it('应检测英文回复风格约束表达', () => {
            const result = scanner.scan(createInteraction('I prefer that you keep responses concise and structured'));
    ...
    describe('用户确认检测', () => {
        ...
        it('应检测英文记忆命令', () => {
            const result = scanner.scan(createInteraction('Please remember this: I use VS Code every day'));
    ...
    describe('模糊词 / 情绪词过滤', () => {
        it('大量模糊词应过滤掉整条消息', () => {
            ...
            const result = scanner.scan(
                createInteraction('可能或许大概应该试试看看'),
            );
        ...
        it('大量情绪词应过滤', () => {
            ...
            const result = scanner.scan(
                createInteraction('真烦，太累了，我是工程师'),
            );
