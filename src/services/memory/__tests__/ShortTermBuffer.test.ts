...
describe('ShortTermBuffer', () => {
  ...
  describe('基本操作', () => {
    ...
    it('getAllMessages 应按正确顺序返回', () => {
      buffer.addMessages(createMessage('user', 'A'), createMessage('assistant', 'B'));
      buffer.addMessages(createMessage('user', 'C'), createMessage('assistant', 'D'));
  ...
  describe('窗口溢出', () => {
    ...
    it('只添加 assistant 消息不影响窗口溢出', () => {
      ...
      const result = buffer.addMessages(createMessage('assistant', '额外回复'));
  ...
  describe('removeByMessageId', () => {
    ...
    it('删除 assistant 消息应成功', () => {
      ...
      buffer.addMessages(createMessage('user', 'A'), createMessage('assistant', 'B', assistantId));
