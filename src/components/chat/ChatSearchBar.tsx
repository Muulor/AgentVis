    ...
    return (
        <div className={styles.searchBar} ref={searchBarRef}>
            ...
            <div className={styles.inputRow}>
                ...
                />
                {localQuery && (
                    <button className={styles.clearBtn} onClick={handleClear} aria-label={t('chat.clearSearch')}>
                        <X size={14} />
                    </button>
                )}
            </div>
                        ...
                        <>
                            ...
                            {results.map((result, index) => (
                                <button
                                    ...
                                    data-search-item
                                    className={cx(styles.resultItem, index === activeIndex && styles.resultItemActive)}
