  ...
  return (
    ...
    >
      ...
      <div className={styles.toolbar} onClick={(e) => e.stopPropagation()}>
        ...
        <button className={styles.toolButton} onClick={handleRotate} title={t('chat.rotate90')}>
          <RotateCw size={18} />
        </button>
        <button className={styles.toolButton} onClick={handleReset} title={t('chat.reset')}>
          {t('chat.reset')}
        </button>
      </div>
