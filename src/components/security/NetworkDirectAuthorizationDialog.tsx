...
function formatResolvedIps(target: { resolvedIpSamples?: string[]; resolvedRiskReason?: string }): string {
                        ...
                        <>
                            ...
                            {hasMetadataTarget && (
                                <div className={styles.riskBanner}>
                                    {t('networkDirectAuth.metadataWarning')}
                                </div>
                            )}

                            {!hasMetadataTarget && hasPrivateTarget && (
                                <div className={styles.riskBanner}>
                                    {t('networkDirectAuth.privateWarning')}
                                </div>
                            )}
                            ...
                            <div className={styles.metaGrid}>
                                ...
                                <code>{request.subjectId ? `${request.subjectType}:${request.subjectId}` : request.subjectType}</code>
                                {request.workdir && (
                                    <>
