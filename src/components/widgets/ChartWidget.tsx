    ...
    for (const item of raw.items) {
        if (typeof item === 'object' && item !== null) {
            ...
            if (label) {
                items.push({
                    label,
                    value: (typeof it.value === 'number' || typeof it.value === 'string') ? it.value : undefined,
                ...
                <div key={index} className={styles.flowStep}>
                    ...
                    >
                        ...
                        <div className={styles.flowNodeText}>
                            ...
                            {item.description && (
                                <span className={styles.flowNodeDesc}>{item.description}</span>
                            )}
                        </div>
                    </div>
                </div>
...
export const ChartWidget = memo(function ChartWidget({
    ...
    return (
        <div className={styles.container}>
            ...
            {/* 底部注脚 */}
            {parsed.footnote && (
                <p className={styles.footnote}>{parsed.footnote}</p>
            )}
                ...
                <div className={styles.actionsBar}>
                    {parsed.actions.map((action, index) => {
                        ...
                        return (
                            <button
                                key={index}
                                className={cx(styles.actionBtn, isClicked && styles.actionClicked, isDisabled && styles.actionDisabled)}
