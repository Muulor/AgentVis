...
export const BubbleReplyBar = memo(function BubbleReplyBar({
  ...
  if (isSubmitted) {
    return (
      <div className={styles.bar}>
        ...
        {submittedExtraText && <p className={styles.submittedExtra}>{submittedExtraText}</p>}
  ...
  return (
    <div className={styles.bar}>
      ...
      <div className={styles.inputRow}>
        ...
        >
          <button
            className={cx(
              styles.confirmBtn,
              ((!hasSelections && !extraText.trim()) || isDispatching) && styles.confirmBtnDisabled
            )}
      ...
      {/* 提示文字 */}
      {!hasSelections && <p className={styles.hint}>{t('widgets.confirmHint')}</p>}
    </div>
  );
});
