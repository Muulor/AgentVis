        ...
        {parsed.options.map((option, index) => {
          ...
          return (
            <button
              ...
              className={cx(
                styles.optionCard,
                isMulti && styles.optionCardMulti,
                isSelected && (isMulti ? styles.multiSelected : styles.optionSelected),
                isFaded && styles.optionDisabled
              )}
              onClick={() =>
                isMulti ? handleMultiClick(option.label) : handleSingleClick(option.label)
              }
              disabled={isDisabled}
            >
              ...
              {isMulti && (
                <span
                  className={cx(styles.checkboxIndicator, isSelected && styles.checkboxChecked)}
                >
