...
export function UpdateSettings() {
  ...
  const hasAvailableUpdate =
    status === 'available' && latest !== null && resolvedDownloadUrl !== null;
      ...
      <div className={styles.updateCard} data-status={status}>
        <div className={styles.updateHeader}>
          <div className={styles.updateStatusBlock}>
            ...
            <span className={styles.updateStatusText}>{statusText}</span>
          </div>
          <button
        ...
        <div className={styles.updateMetaGrid}>
          ...
          <span className={styles.updateMetaLabel}>
            {t('settings.general.updateLatestVersion')}
          </span>
          ...
          <span className={styles.updateMetaValue}>
            {checkedAtText || t('settings.general.updateNeverChecked')}
          </span>
        </div>
        ...
        {latest && (
          <div className={styles.updateNotesBlock}>
            <span className={styles.updateNotesTitle}>
              {t('settings.general.updateNotesTitle')}
            </span>
            <p className={styles.updateNotes}>
              {releaseNotes || t('settings.general.updateNotesEmpty')}
            </p>
          </div>
        )}
        {error && (
        ...
        {skippedVersion && (
          <p className={styles.hint}>
            {t('settings.general.updateSkippedVersion', { version: skippedVersion })}
          </p>
        )}
