...
import {
  useSettingsStore,
  type TaskCompletionNotificationContentMode,
...
export function GeneralSettings() {
  ...
  const taskCompletionNotificationsEnabled = useSettingsStore(
    (state) => state.taskCompletionNotificationsEnabled
  );
  const taskCompletionNotificationsBackgroundOnly = useSettingsStore(
    (state) => state.taskCompletionNotificationsBackgroundOnly
  );
  const taskCompletionNotificationContentMode = useSettingsStore(
    (state) => state.taskCompletionNotificationContentMode
  );
  const setTaskCompletionNotificationsEnabled = useSettingsStore(
    (state) => state.setTaskCompletionNotificationsEnabled
  );
  const setTaskCompletionNotificationsBackgroundOnly = useSettingsStore(
    (state) => state.setTaskCompletionNotificationsBackgroundOnly
  );
  const setTaskCompletionNotificationContentMode = useSettingsStore(
    (state) => state.setTaskCompletionNotificationContentMode
  );
    ...
    <div className={styles.container}>
      ...
      <section className={styles.section}>
        ...
        <label className={styles.toggleRow}>
          <span className={styles.toggleTextGroup}>
            <span className={styles.toggleLabel}>
              {t('settings.general.taskCompletionNotifications')}
            </span>
            <span className={styles.hint}>
              {t('settings.general.taskCompletionNotificationsHint')}
            </span>
          </span>
        ...
        <label className={styles.toggleRow} data-disabled={!taskCompletionNotificationsEnabled}>
          <span className={styles.toggleTextGroup}>
            <span className={styles.toggleLabel}>
              {t('settings.general.taskCompletionNotificationsBackgroundOnly')}
            </span>
            <span className={styles.hint}>
              {t('settings.general.taskCompletionNotificationsBackgroundOnlyHint')}
            </span>
          </span>
          <span className={styles.switchControl}>
            <input
              ...
              onChange={(event) =>
                setTaskCompletionNotificationsBackgroundOnly(event.target.checked)
              }
            />
            <span className={styles.toggleSwitch} />
          </span>
        ...
        <div className={styles.settingField} data-disabled={!taskCompletionNotificationsEnabled}>
          ...
          <Select
            ...
            disabled={!taskCompletionNotificationsEnabled}
            onValueChange={(value) => {
              setTaskCompletionNotificationContentMode(
                value as TaskCompletionNotificationContentMode
              );
            }}
            options={[
              {
          ...
          <p className={styles.hint}>
            {t('settings.general.taskCompletionNotificationContentHint')}
          </p>
        </div>
      </section>
