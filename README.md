...
# AgentVis
<p align="center">
  <a href="https://agentvis.muulor.workers.dev/">官方网站</a> | <a href="https://agentvis-download-1318040347.cos.ap-beijing.myqcloud.com/AgentVis_0.3.4_x64-setup.exe">下载 Windows 版</a>
</p>
<p align="center">
...
<p align="center">
  <a href="docs/使用指南/quick_start.md">快速开始</a>
  ·
  <a href="docs/使用指南/AgentVis%20技能使用指南.md">技能指南</a>
  ·
  <a href="docs/使用指南/AgentVis%20沙箱权限与安全审计指南.md">安全指南</a>
  ·
  <a href="docs/使用指南/IM 机器人配置指南.md">IM使用指南</a>
</p>
...
完整上手流程见 [AgentVis 快速开始指南](docs/使用指南/quick_start.md)。
...
```mermaid
flowchart TB
  User["用户 / 飞书 / Slack / 定时任务"] --> UI["React UI"]
...
边界说明：受控联网模式强调网络出口收口和审计，非所有普通 `exec` 或 Guide Skill 的直连都已经被 OS 层完整捕获。更完整的网络隔离边界见 [沙箱权限与安全审计指南](<docs/使用指南/AgentVis 沙箱权限与安全审计指南.md>) 和 [ControlledNetwork 回归矩阵](<docs/AgentVis docs/AgentVis ControlledNetwork 回归矩阵.md>)。
...
| 文档 | 内容 |
| --- | --- |
| [快速开始](docs/使用指南/quick_start.md) | 从首次安装到模型、云端服务、技能依赖、Agent 设置和工作区配置。 |
| [技能使用指南](<docs/使用指南/AgentVis 技能使用指南.md>) | 全局技能、单 Agent 技能绑定、Guide / Script 区别和常见排查。 |
| [沙箱权限与安全审计指南](<docs/使用指南/AgentVis 沙箱权限与安全审计指南.md>) | 本机审计、受控联网、离线隔离和安全审计事件。 |
| [IM 机器人配置指南](<docs/使用指南/IM 机器人配置指南.md>) | 飞书和 Slack 机器人配置，让 IM 消息触发 Agent 任务。 |
...
本仓库尚未附带开源许可证。正式公开前请在根目录补充 `LICENSE`，并在此处更新许可说明。在许可证明确前，默认保留所有权利。
