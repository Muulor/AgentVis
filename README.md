...
| Visualization enhancement | Planning responses can be automatically enhanced into ECharts, Mermaid, and interactive widgets. |
...
| Scheduled tasks | Agents can run frequency-based or advanced Cron tasks automatically in Planning mode. |
